export default function Message() {
  return (
    <div className="font-just-sans w-full flex pt-[40px] pb-[60px] flex-col gap-[40px] justify-center items-center text-light bg-[#161616] px-[20px]">
      ...
      <div className="flex flex-col text-dark text-[12px] gap-4 bg-normal bg-opacity-20 rounded-[10px] w-[390px] h-auto p-8 font-light ">
        ...
        <div className="flex flex-col gap-4 justify-center items-center">
          <textarea
            ...
            className="rounded-[8px] w-[100%] h-[200px] py-2 px-3 focus:outline-none placeholder-dark placeholder-opacity-65"
          ></textarea>
          <button
            type="submit"
