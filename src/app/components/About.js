export default function About() {
  return (
    <div className="md:px-[80px] lg:px-[120px] xl:px-[140px] font-just-sans w-full flex pt-[40px] pb-[60px] flex-col gap-[40px] justify-center items-center text-light bg-[#191919] px-[30px]">
      {/* Header */}
