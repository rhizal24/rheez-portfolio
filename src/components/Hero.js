  ...
  return (
    ...
    <section>
      <div className="container transition-all duration-600 ease-in-out">
        <div className="flex flex-wrap justify-center px-4 gap-14 text-light">
          {/* Header */}
            ...
            <div className="hidden xl:block w-[50%] relative">
              ...
              <div className="relative z-10 flex items-center justify-center">
                <Image
                  ...
                  width={160}
                  height={160}
                  className="w-[250px] lg:w-[300px] 2xl:w-[320px] h-auto rotate-2 transition-all duration-700 ease-in-out"
                />
              </div>
            </div>
          </div>
